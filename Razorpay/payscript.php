...
<script
    ...
    data-amount="<?php echo $_POST['amount']*100;?>"//"29935" Amount is in currency subunits. Hence, 29935 refers to 29935 paise or ₹299.35.
    data-currency="INR" //You can accept international payments by changing the currency code. Contact our Support Team to enable International for your account
    data-order_id="<?php echo 'OID'.rand(10,100).'END';?>" //order_CgmcjRh9ti2lP7 Replace with the order_id generated by you in the backend.
    data-buttontext="Pay with Razorpay"
    data-name="Solutions"
